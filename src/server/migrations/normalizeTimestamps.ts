...
/**
 * Migration script: normalize learner timestamp fields to ISO strings.
 * Usage:
 *   PB_URL=https://... PB_ADMIN_EMAIL=admin@... PB_ADMIN_PASSWORD=secret node normalizeTimestamps.js
 */
...
async function main() {
  ...
  for (const l of learners) {
    const updates: any = {};
    const timeIn = (l as any).time_in;
    const timeOut = (l as any).time_out;
